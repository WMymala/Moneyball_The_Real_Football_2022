...
```{r}
# Brown-Forsythe for Age
AgeBelgium = MoneyballData[1:25,5]
AgeEngland = MoneyballData[26:50,5]
AgeFrance = MoneyballData[51:75,5]
AgeGermany = MoneyballData[76:100,5]
AgeItaly = MoneyballData[101:127,5]
AgeSpain = MoneyballData[128:151,5]
...
WageBelgium = MoneyballData[1:25,7]
WageEngland = MoneyballData[26:50,7]
WageFrance = MoneyballData[51:75,7]
WageGermany = MoneyballData[76:100,7]
WageItaly = MoneyballData[101:127,7]
WageSpain = MoneyballData[128:151,7]
...
qf(0.95,5,nT-6) ## critical value
```
|TestStat| > Critical Value, so we  reject $H_0$ at significance level α = .05. At α = .05, we observe that all our country's wage error variances are not equal.

```{r}
# Brown-Forsythe for Caps
CapsBelgium = MoneyballData[1:25,8]
CapsEngland = MoneyballData[26:50,8]
CapsFrance = MoneyballData[51:75,8]
CapsGermany = MoneyballData[76:100,8]
CapsItaly = MoneyballData[101:127,8]
CapsSpain = MoneyballData[128:151,8]
