...
Question: How much influence does international caps have on player value based on the best 6 teams in Europe? We have created a dataset for a total of 126 players, which mostly consist of players included in the latest international team setups(November 2021) of five
...
As we can see with the bubble chart, we can see once again that caps is not a good indicator for determining a player's transfer value.
